...
echo "NoGC"
echo "===="
python $kit_root/scripts/compare_report.py NoGC $kit_root/running/results/log/$nogc_run_id 
...
ss_run_id=$(echo $ss_output | cut -c9-33) # output is something like: 'Run id: fox-2020-05-13-Wed-124656'
