...
%booleanopts = (
		...
		"rmmtkprobe" => "-Dprobes=RustMMTk",
		"mmtkprobe" => "-Dprobes=MMTk",
		"openjdkprobe" => "-Dprobes=OpenJDK",

		"nco" => "-XX:-UseCompressedOops",
        "g1" => "-XX:+UseG1GC",
...
@gcconfigs = (
		...
		"jdk-g1|g1|ms|s|c2",
		"jdk-zgc|zgc|ms|s|c2",
		"jdk-parallelgc|parallelgc|ms|s|c2",
		"jdk-serialgc|serialgc|ms|s|c2",
		"jdk-cms|cms|ms|s|c2",
	      );
...
%jvmroot = (
		...
		"jdk-zgc" => "$rootdir/build",
		"jdk-parallelgc" => "$rootdir/build",
		"jdk-serialgc" => "$rootdir/build",
		"jdk-cms" => "$rootdir/build",
	    );
...
@dacapo_9_12 = ("sunflow", "jython", "avrora", "h2", "tradebeans", "tradesoap");
@dacapo_2006 = ("xalan", "pmd", "lusearch", "luindex", "hsqldb", "fop", "eclipse", "chart", "antlr");

# @benchmarks = ("antlr", "fop", "pmd", "hsqldb", "eclipse");
@benchmarks = (@dacapo_2006, @dacapo_9_12);
...
%bmargs = (
	   ...
	   "dacapo" => "-Djava.library.path=$rootdir/../probes/rust_mmtk -cp $rootdir/../probes/probes.jar:$rootdir/../probes/rust_mmtk/java:$rootdir/../probes/openjdk/java:$benchmarkroot/dacapo/dacapo-2006-10-MR2.jar Harness -c probe.Dacapo2006Callback -n [#] [bm]",
	   "dacapobach" => "-Djava.library.path=$rootdir/../probes/rust_mmtk -cp $rootdir/../probes/probes.jar:$rootdir/../probes/rust_mmtk/java:$rootdir/../probes/openjdk/java:$benchmarkroot/dacapo/dacapo-9.12-bach.jar Harness -c probe.DacapoBachCallback -n [#] [bm]",
