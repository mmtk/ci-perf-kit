...
# values for all dacapo benchmarks are set to a fixed number. It times the 'heaprange' to ensure we use a large heap size for NoGC. 
            "_201_compress" => 19,
            "_202_jess" => 19,
            "_205_raytrace" => 19,
            "_209_db" => 19,
